...
2. On the "Create a New Repository", fill "Name" with the following format where `GitHubUsername` is your GitHub username: `GitHubUsername.github.io`.
3. (optional) Provide a description.
4. Note the "Local Path". Click "Choose" to define a new folder for your website.
...
3. Click "Commit to main" (this will clear the left-hand column of changes).
